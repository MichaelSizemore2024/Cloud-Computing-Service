...
type ProtobufInsertRequest struct {
	...
	Protobufs []*any1.Any `protobuf:"bytes,2,rep,name=protobufs,proto3" json:"protobufs,omitempty"` //repeated string servers = 3;
}
...
var file_proto_generic_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x03, 0x28, 0x09, 0x52, 0x04, 0x65, 0x72, 0x72, 0x73, 0x32, 0x4c, 0x0a, 0x0b, 0x44,
	0x42, 0x5f, 0x49, 0x6e, 0x73, 0x65, 0x72, 0x74, 0x65, 0x72, 0x12, 0x3d, 0x0a, 0x06, 0x49, 0x6e,
...
var file_proto_generic_proto_depIdxs = []int32{
	2, // 0: protobuf_insert_request.protobufs:type_name -> google.protobuf.Any
	0, // 1: DB_Inserter.Insert:input_type -> protobuf_insert_request
	1, // 2: DB_Inserter.Insert:output_type -> protobuf_insert_response
